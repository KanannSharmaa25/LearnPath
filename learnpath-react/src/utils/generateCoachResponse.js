// Generates the AI Coach's canned advice text for a given user question.
// Pure function — takes the current user context explicitly instead of
// reading it from component closure, so it can be tested independently
// of the AICoach component.
import knowledgeBase from './coachKnowledgeBase';

function generateCoachResponse(question, { ctx, goal, hours, experience, enrolledCourses }) {
...
export default generateCoachResponse;
